# -*- coding: utf-8 -*-
"""
Created on Sat Apr 30 14:35:34 2022
...
while n<2:
    ...
    # 循环神经网络
    # 隐藏层100
    model.add(layers.LSTM(units=1400, return_sequences=True))
    ...
    # 隐藏层100
    model.add(layers.LSTM(units=1400))
    model.add(Activation('relu'))
    model.add(Dropout(0.1))
    model.add(Dense(1))
...
xi=np.array(kong1).reshape(n,len(Y))
